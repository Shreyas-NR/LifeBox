...
#ifndef INC_ADS1115_ADS1115_H_
#define INC_ADS1115_ADS1115_H_
...
/*=========================================================================
    I2C ADDRESS/BITS
    -----------------------------------------------------------------------*/
#define ADS1115_ADDRESS ((0x48)<<1) ///< 1001 000 (ADDR = GND)
/*=========================================================================*/
...
uint8_t ConvRegValue[2];
uint16_t ConversionValue;

float ReadPHSensor();
void ReadFlowSensor();

#endif /* INC_ADS1115_ADS1115_H_ */
